...
public class NotificationDetails implements Serializable {
  ...
  // Latermark patch: a custom interval is a Dart 64-bit integer. Keeping this
  // as Integer overflows beyond ~24.8 days (30/365-day reminders are valid).
  public Long repeatIntervalMilliseconds;
  ...
  public static NotificationDetails from(Map<String, Object> arguments) {
    ...
    if (arguments.containsKey(REPEAT_INTERVAL_MILLISECONDS)) {
      notificationDetails.repeatIntervalMilliseconds =
          ((Number) arguments.get(REPEAT_INTERVAL_MILLISECONDS)).longValue();
    }
